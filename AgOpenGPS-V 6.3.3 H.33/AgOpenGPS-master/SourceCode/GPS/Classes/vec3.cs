...
namespace AgOpenGPS
{
    ...
    /// </summary>
    public struct vecRoll
    {
        public double easting; //easting
        public double heading; //heading etc
        public double northing; //northing
        public double toolroll;    //roll

        public vecRoll(double _easting, double _northing, double _heading, double _toolroll)
        {
            this.easting = _easting;
            this.heading = _heading;
            this.northing = _northing;
            this.toolroll = _toolroll;
        }
    }
    //
