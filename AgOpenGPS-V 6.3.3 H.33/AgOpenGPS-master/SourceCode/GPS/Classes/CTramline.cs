...
namespace AgOpenGPS
{
    public class CTramline
    {
        private readonly FormGPS mf;

        public List<CTramlinePath> tracksArrtraml = new List<CTramlinePath>();

        public int idxtraml;

        public List<vec3> desListtraml = new List<vec3>();
    ...
    public class CTramlinePath
    {
        public List<vec3> trackPtstraml = new List<vec3>();
        public string name = "";
