...
namespace AgOpenGPS
{
    public class CContour
    {
        ...
        public double inty, NewToolWidth;
        ...
        public List<List<vec3>> ContourLineList = new List<List<vec3>>();

        //list of points for the new contour line
        public List<vec3> ctList = new List<vec3>();
        public List<vec3> ctListA = new List<vec3>();
        public List<vec3> ctListB = new List<vec3>();
        public List<vec3> ctListSmoothA = new List<vec3>();
        public List<vec3> ctListSmoothB = new List<vec3>();

        //constructor
        public CContour(FormGPS _f)
        {
            mf = _f;
            ctListA.Capacity = 128;
            ctListB.Capacity = 128;
            ptList.Capacity = 128;
        }
