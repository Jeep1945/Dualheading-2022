...
namespace AgOpenGPS
{
    public partial class CBoundaryList
    {
        ...
        public List<vec3> fenceLine_new = new List<vec3>(128);
        public List<vec3> fenceLine_original = new List<vec3>(128);
        public List<vec3> boundaryTramlLine = new List<vec3>(128);
