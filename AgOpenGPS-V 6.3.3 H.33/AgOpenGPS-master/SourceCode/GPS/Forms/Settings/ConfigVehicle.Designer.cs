...
namespace AgOpenGPS
{
    public partial class FormConfig
    {
        ...
        private void SaveDisplaySettings()
        {
            ...
            mf.isLineNumberon = cboxLinenumbers.Checked;
            ...
            Properties.Settings.Default.setMenu_GuidanceLine9 = mf.GuidanceLine9;
        ...
        private void rbtnAntennaCenter_Click(object sender, EventArgs e)
        {
            mf.vehicle.antennaOffset = 0;
            nudAntennaOffset.Value = 0;
            rbtnAntennaLeft.Checked = false;
