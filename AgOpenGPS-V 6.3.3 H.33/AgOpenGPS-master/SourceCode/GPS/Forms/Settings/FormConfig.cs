...
namespace AgOpenGPS
{
    public partial class FormConfig : Form
    {
        ...
        public FormConfig(Form callingForm)
        {
            ...
            //nudSetGuidanceLine9.Value = mf.GuidanceLine9 - 1;
        }
        ...
        private void tabDisplay_Enter(object sender, EventArgs e)
        {
            ...
            cboxLinenumbers.Checked = mf.isLineNumberon;
        ...
        private void chkDisplayExtraGuides_CheckedChanged(object sender, EventArgs e)
        {
           
        }

        private void nudSetGuidanceLine9_Click(object sender, EventArgs e)
        {
            mf.KeypadToNUD((NudlessNumericUpDown)sender, this);
            mf.GuidanceLine9 = (int)nudSetGuidanceLine9.Value + 1;
        }

        private void rbtnAntennaCenter_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void rbtnAntennaLeft_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void nudTractorHitchLength_ValueChanged_1(object sender, EventArgs e)
        {
        ...
        private void lblVehicleToolWidth_Click(object sender, EventArgs e)
        {
        ...
        private void rbtnDisplayImperial_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void nudHydLiftLookAhead_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void chkSectionLines_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void hsbarRollFilter_Scroll(object sender, ScrollEventArgs e)
        {
