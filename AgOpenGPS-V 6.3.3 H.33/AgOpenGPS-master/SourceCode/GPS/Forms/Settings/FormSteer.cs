...
namespace AgOpenGPS
{
    public partial class FormSteer : Form
    {
        ...
        private void FormSteer_Load(object sender, EventArgs e)
        {
            ...
            if (mf.isStanleyUsed) tabControl1.TabPages.Remove(tabPP);
        ...
        */
        ...
        private void hScrollBarMPUHeading_Scroll(object sender, ScrollEventArgs e)
        {
        ...
        private void hsbarLookAheadMult_ValueChanged(object sender, ScrollEventArgs e)
        {
            mf.vehicle.goalPointLookAheadMult = hsbarLookAheadMult.Value * 0.1;
            lblLookAheadMult.Text = mf.vehicle.goalPointLookAheadMult.ToString();
        }

        private void hsbarAcquireFactor_ValueChanged(object sender, ScrollEventArgs e)
        {
