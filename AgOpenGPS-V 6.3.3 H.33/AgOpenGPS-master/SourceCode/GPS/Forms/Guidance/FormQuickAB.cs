...
namespace AgOpenGPS
{
    public partial class FormQuickAB : Form
    {
        ...
        int RefSideCurve_Click = 1;

        private void btnRefSideCurve_Click(object sender, EventArgs e)
        {
            RefSideCurve_Click++;
            if (RefSideCurve_Click > 3) RefSideCurve_Click = 1;
            if (RefSideCurve_Click < 3)
            {
            ...
            if (RefSideCurve_Click == 3)
            {
                btnRefSideCurve.Image = Properties.Resources.TrackFix1;
            }
        }
        ...
        {
            if (textBox1.Text.Length == 0) textBox1.Text = "No Name " + DateTime.Now.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
        ...
        private void btnFixLineCurveQu_Click(object sender, EventArgs e)
        {
