...
namespace AgOpenGPS
{
    public partial class FormBuildTracks : Form
    {
        ...
        private void FormBuildTracks_Load(object sender, EventArgs e)
        {
            ...
            panelCurve1.Top = 3; panelCurve1.Left = 3;
        ...
        private void UpdateTable()
        {
            ...
            for (int i = 0; i < mf.trk.gArr.Count; i++)
            {
                ...
                else if (mf.trk.gArr[i].mode == (int)TrackMode.Curve)
                    b.Image = Properties.Resources.TrackCurve;
                else  // for TrackMode is Pattern
                    b.Image = Properties.Resources.TrackCurve;
        ...
        int RefSideCurve1_Click = 1;
        #region Curve
        private void btnRefSideCurve1_Click_1(object sender, EventArgs e)
        {
            RefSideCurve1_Click++;
            if (RefSideCurve1_Click > 3) RefSideCurve1_Click = 1;
            if (RefSideAPlus_Click < 3)
            {
                isRefRightSide = !isRefRightSide;
                btnRefSideCurve1.Image = isRefRightSide ?
                Properties.Resources.BoundaryRight : Properties.Resources.BoundaryLeft;
            }
            if (RefSideCurve1_Click == 3)
            {
                btnRefSideCurve1.Image = Properties.Resources.TrackFix1;
            }
        }

        private void btnACurve1_Click(object sender, EventArgs e)
        {
            lblCurveExists.Text = gStr.gsDriving;

            btnBCurve1.Enabled = true;
            btnACurve1.Enabled = false;

            btnPausePlay1.Enabled = true;
            btnPausePlay1.Visible = true;

            mf.curve.isMakingCurve = true;
        }

        private void btnBCurve1_Click_1(object sender, EventArgs e)
        {
            aveLineHeading = 0;
            mf.curve.isMakingCurve = false;
            panelCurve1.Visible = false;
            ...
            if (cnt > 3)
            {
                ...
                else if (RefSideCurve1_Click == 3)
                {
                    mf.trk.idx = idx;
                    dist = 0;
                    mf.trk.NudgeRefCurve(dist);
                    textBox1.Text = "&FIX " + mf.curve.desName;
                }
            }
            else
            {
        ...
        private void btnPausePlayCurve1_Click(object sender, EventArgs e)
        {
            if (mf.curve.isMakingCurve)
            {
                mf.curve.isMakingCurve = false;
                btnPausePlay1.Image = Properties.Resources.BoundaryRecord;
                //btnPausePlay.Text = gStr.gsRecord;
                btnBCurve1.Enabled = false;
            }
            else
            {
                mf.curve.isMakingCurve = true;
                btnPausePlay1.Image = Properties.Resources.boundaryPause;
                //btnPausePlay.Text = gStr.gsPause;
                btnBCurve1.Enabled = true;
            }
        }
        ...
        int RefSideAB_Click = 1;
        private void btnRefSideAB_Click(object sender, EventArgs e)
        {
            RefSideAB_Click++;
            if (RefSideAB_Click > 3) RefSideAB_Click = 1;
            if (RefSideAB_Click < 3)
            {
                isRefRightSide = !isRefRightSide;
            ...
            if (RefSideAB_Click == 3)
            {
                btnRefSideAB.Image = Properties.Resources.TrackFix1;
            }
        }
        ...
        private void btnEnter_AB_Click(object sender, EventArgs e)
        {
            ...
            else if (RefSideAB_Click == 3)
            {
                mf.trk.idx = idx;
                dist = 0;
                mf.trk.NudgeRefABLine(dist);
                textBox1.Text = "&FIX " + mf.ABLine.desName;
            }
        ...
        int RefSideAPlus_Click = 1;
        private void btnRefSideAPlus_Click(object sender, EventArgs e)
        {
            RefSideAPlus_Click++;
            if (RefSideAPlus_Click > 3) RefSideAPlus_Click = 1;
            if (RefSideAPlus_Click < 3)
            {
                isRefRightSide = !isRefRightSide;
            ...
            if (RefSideAPlus_Click == 3)
            {
                btnRefSideAPlus.Image = Properties.Resources.TrackFix1;
            }
        }
        ...
        #endregion
        private void btnCancel_Curve1_Click(object sender, EventArgs e)
        {
        ...
        {
            if (textBox1.Text.Length == 0) textBox2.Text = "No Name " + DateTime.Now.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
        ...
        {
            textBox1.Text += DateTime.Now.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
            mf.curve.desName = textBox1.Text;
        }

        private void btnAddDateEdit_Click(object sender, EventArgs e)
        {
            textBox2.Text += DateTime.Now.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
        }

        private void btnSaveEditName_Click(object sender, EventArgs e)
        {
            if (textBox2.Text.Trim() == "") textBox2.Text = "No Name " + DateTime.Now.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);
        ...
        private void btnFixLineCurve_Click(object sender, EventArgs e)
        {
            textBox1.Text = "&FIX " + textBox1.Text;
        }

        private void btnFixEdit_Click(object sender, EventArgs e)
        {
            textBox2.Text = "&FIX " + textBox1.Text;
        }
