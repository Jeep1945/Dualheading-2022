...
void sendGGA_WiFi() {
  ...
  if (lonEW == "")
  {
    GGASatz_send_back = "$GPGGA,064450.300,4811.862,N,01500.026,E,1,12,1.0,0.0,M,0.0,M,,*";
  }
  else
  {
    ...
    (GGASatz_send_back.concat(BS));
    (GGASatz_send_back.concat(fixQuality));
    (GGASatz_send_back.concat(",12,1.0,0.0,M,0.0,M,,*"));
  } /*
  GGASatz_send_back = ("$GPGGA," + GGAZeit + "0," + GGAnord.substring(0, 8) + "," + GGANordSued + "," + GGAeast.substring(0, 9) +
        "," + GGAWestEast + "," + fixQuality + ",12,1.0,0.0,M,0.0,M,,*");
*/
